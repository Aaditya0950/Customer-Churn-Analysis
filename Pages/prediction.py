...
churn_data = pd.read_csv(
    "/home/sys-72/Downloads/Customer-Churn-Analysis-and-Classification-main/tel_churn.csv")
x = churn_data.drop('Churn', axis=1)
y = churn_data['Churn']
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.2)

loaded_model = pickle.load(open(
    '/home/sys-72/Downloads/Customer-Churn-Analysis-and-Classification-main/LICENSE', 'rb'))
